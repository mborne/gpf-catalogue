...
function Disclaimer(): JSX.Element {
  return (
    <p className="disclaimer" role="note">
      ...
      Almost everything here — the code, this page and its wording — was generated by{" "}
      <a href="https://claude.ai" rel="noopener noreferrer" target="_blank">
        Claude
      </a>
      . The figures are computed from a copy of the public CSW catalogue rebuilt once a
      week, so they lag behind it and may be wrong; the authoritative source is{" "}
      <a
